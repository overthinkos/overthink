...
| bootc images / `bazzite` / `aurora` / `*-bootc` / `image/bootc` submodule | `/ov-distros:bazzite` + `/ov-distros:aurora` + `/ov-openclaw:openclaw-browser-bootc` + `/ov-selkies:selkies-desktop-bootc` + `/ov-distros:bootc-base` + `/ov-vm:vm` |
