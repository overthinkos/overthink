...
| "What does layer X do?" / "What's in image X?" — base distros / GPU runtime / bootc | `/ov-distros:<name>` (archlinux, fedora, debian, ubuntu, nvidia, cuda, rocm, bootc-base, …) |
