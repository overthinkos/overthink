...
// provider.go is the (inert) gRPC half of this command-only plugin. command:clean is
...
// Invoke is unreachable for this command-only plugin: charly dispatches command:clean by
