module github.com/overthinkos/overthink/candy/plugin-example-structkind
...
// in-tree charly (proto + sdk + spec). A published external plugin would require a tagged
