...
// service-custom / repo-change / apk-install / system-packages) are COMPILER-EMITTED from
// declarative candy fields (copy:/env:/service:/package:/…), never authored as a `plugin:` step, so
