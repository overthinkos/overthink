...
// TestLoadRuntimeConfig_* moved to charly core (charly/migrate_runtime_config_test.go) —
// they exercise the CORE runtime-config loader's kdbx-residual rejection gate
// (LoadRuntimeConfig + RuntimeConfigPath, package-main), not this migrator (C13a).
