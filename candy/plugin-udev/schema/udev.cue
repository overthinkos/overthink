...
//
// udev is a COMMAND-class plugin: charly dispatches it by fork/exec'ing this binary in CLI
...
#UdevPlugin: {
	command:  "udev"
	contract: "udev is CLI-dispatched (charly fork/execs the binary); args are plain CLI tokens (generate | install | remove | status)"
}
