...
func TestResolveImageRefForEnsure_RemoteRef(t *testing.T) {
	ref, err := resolveImageRefForEnsure("@github.com/overthinkos/overthink/check-target:latest", nil, "")
	if err != nil {
...
func TestResolveImageRefForEnsure_FullRef(t *testing.T) {
	ref, err := resolveImageRefForEnsure("ghcr.io/overthinkos/check-target:2026.124.1253", nil, "")
	if err != nil {
		t.Fatalf("full ref err: %v", err)
	}
	if ref != "ghcr.io/overthinkos/check-target:2026.124.1253" {
