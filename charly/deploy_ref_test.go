...
func TestResolveDeployRefLocalImage(t *testing.T) {
	...
	// shape with version: 2026.164.0006 and the singular box: kind map.
	if err := os.WriteFile(filepath.Join(dir, "charly.yml"), []byte(`
version: 2026.164.0006
box:
  myimg:
    base: fedora
`), 0644); err != nil {
...
`), 0644); err != nil {
	...
	_ = os.WriteFile(filepath.Join(dir, "charly.yml"), []byte("version: 2026.164.0006\nimage: {}\n"), 0644)
