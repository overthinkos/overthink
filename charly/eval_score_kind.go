...
//
// A score is the unit you actually invoke: `charly eval run <score>`.
...
// HarnessScore is the runner config for `charly eval run <name>`.
//
...
var (
	...
	ErrNoScores = errors.New("eval: no scores configured (add a 'score:' map to eval.yml)")
...
// Used by `charly eval list-score`.
