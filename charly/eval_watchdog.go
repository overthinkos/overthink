...
//      RunEvalLive against the iter's in-scope scenarios.
...
//     no entry in `charly eval scope`, no log line in NOTES.md.
...
// current score. Concrete implementations call RunEvalLive
