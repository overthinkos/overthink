...
func TestImportList_Unmarshal(t *testing.T) {
	root := t.TempDir()
	writeFixture(t, root, "charly.yml", `version: 2026.161.1502
import:
  - build.yml
  - sub: ./sub.yml
`)
  ...
  build: [rpm]
`)
	writeFixture(t, root, "sub.yml", `version: 2026.161.1502
box:
  widget:
...
box:
  app:
    ...
    build: [rpm]
`)
	writeFixture(t, root, "sub/charly.yml", `version: 2026.161.1502
import:
  - up: ../
box:
  widget:
