...
// OvNetworkName is the shared bridge network used by all charly containers.
const OvNetworkName = "charly"

// EnsureOvNetwork creates the "charly" network if it does not exist.
