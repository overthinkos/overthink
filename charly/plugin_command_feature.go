...
// as a dedicated COMMAND-class provider — the same externalizable pattern landed
// for udev (see plugin_command_udev.go for the full rationale). It self-registers
