...
// emitUnitSection writes the [Unit] section of the quadlet .container file.
...
// emitContainerSection writes the [Container] section of the quadlet .container file.
...
// emitContainerSecurity writes the device/capability/security-opt directives of
// the [Container] section, branching on privileged vs unprivileged mode.
...
// emitServiceSection writes the [Service] section of the quadlet .container file.
...
// emitInstallSection writes the [Install] section of the quadlet .container file.
