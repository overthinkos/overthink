...
type QuadletConfig struct {
	ImageName       string              // image name from charly.yml (e.g. "fedora-test")
...
func generateQuadlet(cfg QuadletConfig) string {
	...
	b.WriteString(fmt.Sprintf("# %s.container (generated by charly config)\n", name))
	if cfg.Version != "" {
...
func generateTunnelUnit(cfg QuadletConfig) string {
	...
	var b strings.Builder
	b.WriteString(fmt.Sprintf("# %s-tunnel.service (generated by charly config)\n", name))
	b.WriteString("[Unit]\n")
