...
// (K8sSpec; absorbed the former ClusterProfile). OPEN tail for forward fields;
// the documented enum domains + sub-object shapes are constrained. Plural field
// names that mirror Kubernetes output keys are preserved verbatim. Shared #Step
// from _common.cue.
