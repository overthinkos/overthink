...
func TestBuildShellArgs(t *testing.T) {
	withTerminal(t, true)
	args := buildShellArgs("docker", "ghcr.io/overthinkos/fedora:latest", 1000, 1000, nil, nil, nil, false, "", "127.0.0.1", nil, SecurityConfig{}, "/workspace")
	want := []string{
		"docker", "run", "--rm", "-it",
		"-w", "/workspace",
		"--user", "1000:1000",
...
func TestBuildShellArgsCustomUIDGID(t *testing.T) {
	withTerminal(t, true)
	args := buildShellArgs("docker", "fedora:latest", 1001, 1002, nil, nil, nil, false, "", "127.0.0.1", nil, SecurityConfig{}, "/workspace")
	want := []string{
		"docker", "run", "--rm", "-it",
		"-w", "/workspace",
		"--user", "1001:1002",
...
func TestBuildShellArgsWithPorts(t *testing.T) {
	withTerminal(t, true)
	args := buildShellArgs("docker", "ghcr.io/overthinkos/fedora:latest", 1000, 1000, []string{"9090:9090", "8080:8080"}, nil, nil, false, "", "127.0.0.1", nil, SecurityConfig{}, "/workspace")
	want := []string{
		"docker", "run", "--rm", "-it",
		"-w", "/workspace",
		"--user", "1000:1000",
...
func TestBuildShellArgsWithSinglePort(t *testing.T) {
	withTerminal(t, true)
	args := buildShellArgs("docker", "ghcr.io/overthinkos/fedora:latest", 1000, 1000, []string{"8080"}, nil, nil, false, "", "127.0.0.1", nil, SecurityConfig{}, "/workspace")
	want := []string{
		"docker", "run", "--rm", "-it",
		"-w", "/workspace",
		"--user", "1000:1000",
...
func TestBuildShellArgsWithVolumes(t *testing.T) {
	...
	args := buildShellArgs("docker", "ghcr.io/overthinkos/openclaw:latest", 1000, 1000, nil, volumes, nil, false, "", "127.0.0.1", nil, SecurityConfig{}, "/workspace")
	want := []string{
		"docker", "run", "--rm", "-it",
		"-w", "/workspace",
		"--user", "1000:1000",
...
func TestBuildShellArgsWithGPU(t *testing.T) {
	withTerminal(t, true)
	args := buildShellArgs("docker", "ghcr.io/overthinkos/ollama:latest", 1000, 1000, nil, nil, nil, true, "", "127.0.0.1", nil, SecurityConfig{}, "/workspace")
	want := []string{
		"docker", "run", "--rm", "-it",
		"-w", "/workspace",
		"--user", "1000:1000",
...
func TestBuildShellArgsWithGPUPodman(t *testing.T) {
	withTerminal(t, true)
	args := buildShellArgs("podman", "ghcr.io/overthinkos/ollama:latest", 1000, 1000, nil, nil, nil, true, "", "127.0.0.1", nil, SecurityConfig{}, "/workspace")
	want := []string{
		"podman", "run", "--rm", "-it",
		"-w", "/workspace",
		"--user", "1000:1000",
...
func TestBuildShellArgsWithoutGPU(t *testing.T) {
	args := buildShellArgs("docker", "ghcr.io/overthinkos/ollama:latest", 1000, 1000, nil, nil, nil, false, "", "127.0.0.1", nil, SecurityConfig{}, "/workspace")
...
func TestBuildShellArgsWithCommand(t *testing.T) {
	...
	args := buildShellArgs("docker", "ghcr.io/overthinkos/fedora:latest", 1000, 1000, nil, nil, nil, false, "echo hello", "127.0.0.1", nil, SecurityConfig{}, "/workspace")
	want := []string{
		"docker", "run", "--rm", "-i",
		"-w", "/workspace",
		"--user", "1000:1000",
...
func TestBuildShellArgsWithCommandAndGPU(t *testing.T) {
	withTerminal(t, false)
	args := buildShellArgs("docker", "ghcr.io/overthinkos/ollama:latest", 1000, 1000, nil, nil, nil, true, "nvidia-smi", "127.0.0.1", nil, SecurityConfig{}, "/workspace")
	want := []string{
		"docker", "run", "--rm", "-i",
		"-w", "/workspace",
		"--user", "1000:1000",
...
func TestBuildExecArgs(t *testing.T) {
	withTerminal(t, true)
	args := buildExecArgs("docker", "charly-fedora", 1000, 1000, "", nil, "/workspace")
	want := []string{
		"docker", "exec", "-it",
		"--user", "1000:1000",
		"-w", "/workspace",
...
func TestBuildExecArgsWithCommand(t *testing.T) {
	withTerminal(t, false)
	args := buildExecArgs("docker", "charly-openclaw", 1000, 1000, "echo hello", nil, "/workspace")
	want := []string{
		"docker", "exec", "-i",
		"--user", "1000:1000",
		"-w", "/workspace",
...
func TestBuildShellArgsWithCommandTTY(t *testing.T) {
	withTerminal(t, true)
	args := buildShellArgs("docker", "ghcr.io/overthinkos/fedora:latest", 1000, 1000, nil, nil, nil, false, "openclaw tui", "127.0.0.1", nil, SecurityConfig{}, "/workspace")
	want := []string{
		"docker", "run", "--rm", "-it",
		"-w", "/workspace",
		"--user", "1000:1000",
...
func TestBuildExecArgsWithCommandTTY(t *testing.T) {
	withTerminal(t, true)
	args := buildExecArgs("docker", "charly-openclaw", 1000, 1000, "openclaw tui", nil, "/workspace")
	want := []string{
		"docker", "exec", "-it",
		"--user", "1000:1000",
		"-w", "/workspace",
...
func TestBuildShellArgsForceTTY(t *testing.T) {
	...
	args := buildShellArgs("docker", "ghcr.io/overthinkos/fedora:latest", 1000, 1000, nil, nil, nil, false, "openclaw models auth login", "127.0.0.1", nil, SecurityConfig{}, "/workspace")
	want := []string{
		"docker", "run", "--rm", "-it",
		"-w", "/workspace",
		"--user", "1000:1000",
...
func TestBuildExecArgsForceTTY(t *testing.T) {
	withTerminal(t, false) // no real terminal
	withForceTTY(t, true)  // but --tty flag set
	args := buildExecArgs("docker", "charly-openclaw", 1000, 1000, "openclaw models auth login", nil, "/workspace")
	want := []string{
		"docker", "exec", "-it",
		"--user", "1000:1000",
		"-w", "/workspace",
...
func TestBuildExecArgsCustomUIDGID(t *testing.T) {
	withTerminal(t, true)
	args := buildExecArgs("podman", "charly-ubuntu", 1001, 1002, "", nil, "/workspace")
	want := []string{
		"podman", "exec", "-it",
		"--user", "1001:1002",
		"-w", "/workspace",
...
func TestBuildShellArgsWithEnvVars(t *testing.T) {
	...
	args := buildShellArgs("docker", "myapp:latest", 1000, 1000, nil, nil, nil, false, "", "127.0.0.1", envVars, SecurityConfig{}, "/workspace")
...
func TestBuildExecArgsWithEnvVars(t *testing.T) {
	...
	args := buildExecArgs("docker", "charly-myapp", 1000, 1000, "", envVars, "/workspace")
	want := []string{
		"docker", "exec", "-it",
		"--user", "1000:1000",
		"-w", "/workspace",
