...
// binary-embedded charly_defaults.yml `sidecar:` library (embed_defaults.go); a project
...
// declarations (the embedded charly_defaults.yml `sidecar:` section: each key maps to
...
//
// Example template (embedded charly_defaults.yml `sidecar:` section):
//
//	sidecar:
//	  tailscale:
//	    parameter:
...
// lives in the binary-embedded charly_defaults.yml `sidecar:` section and is read as
...
// library (the charly_defaults.yml `sidecar:` section), read through the unified loader
