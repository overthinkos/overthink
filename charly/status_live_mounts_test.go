...
func TestIsEncryptedPlainPath(t *testing.T) {
	cases := []struct {
	...
	}{
		{
			...
			path: "/home/atrawog/.local/share/charly/encrypted/charly-immich-library/plain",
			want: true,
		},
		{
...
func TestFormatLiveMounts(t *testing.T) {
	cases := []struct {
		...
		},
		{
			...
			mounts: []MountInfo{
				{Type: "bind", Name: "", Source: "/home/atrawog/.local/share/charly/encrypted/charly-immich-library/plain", Destination: "/home/user/.immich/library"},
			},
			want: []string{
				"bind: /home/atrawog/.local/share/charly/encrypted/charly-immich-library/plain -> /home/user/.immich/library (enc)",
			},
		},
		{
