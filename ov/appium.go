...
// AppiumCmd groups the `ov eval appium …` surface across three tiers:
//
...
// AppiumGestureCmd — `ov eval appium gesture <op>`; flat `gesture-<op>` in eval YAML.
...
// AppiumAppCmd — `ov eval appium app <op>`; flat `app-<op>` in eval YAML.
...
// AppiumKeyCmd — `ov eval appium key <op>`; flat `key-<op>` in eval YAML.
...
// AppiumDeviceCmd — `ov eval appium device <op>`; flat `device-<op>` in eval YAML.
