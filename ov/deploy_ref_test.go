...
func TestResolveDeployRefLocalImage(t *testing.T) {
	...
	// shape with version: 2026.141.1600 and the singular image: kind map.
...
`), 0644); err != nil {
	...
	_ = os.WriteFile(filepath.Join(dir, "overthink.yml"), []byte("version: 2026.141.1600\nimage: {}\n"), 0644)
