...
// ModuleSpec is the ov authoring shape for a Calamares-style installer module
...
// else, ov stays snake_case.
type ModuleSpec struct {
	Name        string `yaml:"name" json:"name"`
	Description string `yaml:"description,omitempty" json:"description,omitempty"` // ov extension; Calamares module.desc has no description
