...
func TestImportList_Unmarshal(t *testing.T) {
	root := t.TempDir()
	writeFixture(t, root, "overthink.yml", `version: 2026.156.1531
import:
  - build.yml
  - sub: ./sub.yml
`)
  ...
  build: [rpm]
`)
	writeFixture(t, root, "sub.yml", `version: 2026.156.1531
box:
  widget:
...
box:
  app:
    ...
    build: [rpm]
`)
	writeFixture(t, root, "sub/overthink.yml", `version: 2026.156.1531
import:
  - up: ../
box:
  widget:
