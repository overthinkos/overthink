...
func TestBuildShellArgs(t *testing.T) {
	withTerminal(t, true)
	args := buildShellArgs("docker", "ghcr.io/overthinkos/fedora:latest", "/home/user/project", 1000, 1000, nil, nil, nil, false, "", "127.0.0.1", nil)
	want := []string{
		"docker", "run", "--rm", "-it",
...
func TestBuildShellArgsCustomUIDGID(t *testing.T) {
	withTerminal(t, true)
	args := buildShellArgs("docker", "fedora:latest", "/tmp", 1001, 1002, nil, nil, nil, false, "", "127.0.0.1", nil)
	want := []string{
		"docker", "run", "--rm", "-it",
		"-v", "/tmp:/workspace",
		"-w", "/workspace",
...
func TestBuildShellArgsWithPorts(t *testing.T) {
	withTerminal(t, true)
	args := buildShellArgs("docker", "ghcr.io/overthinkos/fedora:latest", "/home/user/project", 1000, 1000, []string{"9090:9090", "8080:8080"}, nil, nil, false, "", "127.0.0.1", nil)
	want := []string{
		"docker", "run", "--rm", "-it",
		"-v", "/home/user/project:/workspace",
		"-w", "/workspace",
...
func TestBuildShellArgsWithSinglePort(t *testing.T) {
	withTerminal(t, true)
	args := buildShellArgs("docker", "ghcr.io/overthinkos/fedora:latest", "/home/user/project", 1000, 1000, []string{"8080"}, nil, nil, false, "", "127.0.0.1", nil)
	want := []string{
		"docker", "run", "--rm", "-it",
		"-v", "/home/user/project:/workspace",
		"-w", "/workspace",
...
func TestBuildShellArgsWithVolumes(t *testing.T) {
	...
	args := buildShellArgs("docker", "ghcr.io/overthinkos/openclaw:latest", "/home/user/project", 1000, 1000, nil, volumes, nil, false, "", "127.0.0.1", nil)
	want := []string{
		"docker", "run", "--rm", "-it",
		"-v", "/home/user/project:/workspace",
		"-w", "/workspace",
...
func TestBuildShellArgsWithGPU(t *testing.T) {
	withTerminal(t, true)
	args := buildShellArgs("docker", "ghcr.io/overthinkos/ollama:latest", "/home/user/project", 1000, 1000, nil, nil, nil, true, "", "127.0.0.1", nil)
	want := []string{
		"docker", "run", "--rm", "-it",
		"-v", "/home/user/project:/workspace",
		"-w", "/workspace",
...
func TestBuildShellArgsWithGPUPodman(t *testing.T) {
	withTerminal(t, true)
	args := buildShellArgs("podman", "ghcr.io/overthinkos/ollama:latest", "/home/user/project", 1000, 1000, nil, nil, nil, true, "", "127.0.0.1", nil)
	want := []string{
		"podman", "run", "--rm", "-it",
		"-v", "/home/user/project:/workspace",
		"-w", "/workspace",
...
func TestBuildShellArgsWithoutGPU(t *testing.T) {
	args := buildShellArgs("docker", "ghcr.io/overthinkos/ollama:latest", "/home/user/project", 1000, 1000, nil, nil, nil, false, "", "127.0.0.1", nil)
...
func TestBuildShellArgsWithCommand(t *testing.T) {
	...
	args := buildShellArgs("docker", "ghcr.io/overthinkos/fedora:latest", "/home/user/project", 1000, 1000, nil, nil, nil, false, "echo hello", "127.0.0.1", nil)
	want := []string{
		"docker", "run", "--rm", "-i",
		"-v", "/home/user/project:/workspace",
		"-w", "/workspace",
...
func TestBuildShellArgsWithCommandAndGPU(t *testing.T) {
	withTerminal(t, false)
	args := buildShellArgs("docker", "ghcr.io/overthinkos/ollama:latest", "/home/user/project", 1000, 1000, nil, nil, nil, true, "nvidia-smi", "127.0.0.1", nil)
	want := []string{
		"docker", "run", "--rm", "-i",
		"-v", "/home/user/project:/workspace",
		"-w", "/workspace",
...
func TestBuildShellArgsWithCommandTTY(t *testing.T) {
	withTerminal(t, true)
	args := buildShellArgs("docker", "ghcr.io/overthinkos/fedora:latest", "/home/user/project", 1000, 1000, nil, nil, nil, false, "openclaw tui", "127.0.0.1", nil)
	want := []string{
		"docker", "run", "--rm", "-it",
		"-v", "/home/user/project:/workspace",
		"-w", "/workspace",
...
func TestBuildShellArgsWithEnvVars(t *testing.T) {
	...
	args := buildShellArgs("docker", "myapp:latest", "/workspace", 1000, 1000, nil, nil, nil, false, "", "127.0.0.1", envVars)
