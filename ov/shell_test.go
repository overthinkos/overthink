...
func TestBuildExecArgs(t *testing.T) {
	withTerminal(t, true)
	args := buildExecArgs("docker", "ov-fedora", 1000, 1000, "", nil, "/workspace")
	want := []string{
		"docker", "exec", "-it",
		"--user", "1000:1000",
		"-w", "/workspace",
...
func TestBuildExecArgsWithCommand(t *testing.T) {
	withTerminal(t, false)
	args := buildExecArgs("docker", "ov-openclaw", 1000, 1000, "echo hello", nil, "/workspace")
	want := []string{
		"docker", "exec", "-i",
		"--user", "1000:1000",
		"-w", "/workspace",
...
func TestBuildExecArgsWithCommandTTY(t *testing.T) {
	withTerminal(t, true)
	args := buildExecArgs("docker", "ov-openclaw", 1000, 1000, "openclaw tui", nil, "/workspace")
	want := []string{
		"docker", "exec", "-it",
		"--user", "1000:1000",
		"-w", "/workspace",
...
func TestBuildExecArgsForceTTY(t *testing.T) {
	withTerminal(t, false) // no real terminal
	withForceTTY(t, true)  // but --tty flag set
	args := buildExecArgs("docker", "ov-openclaw", 1000, 1000, "openclaw models auth login", nil, "/workspace")
	want := []string{
		"docker", "exec", "-it",
		"--user", "1000:1000",
		"-w", "/workspace",
...
func TestBuildExecArgsCustomUIDGID(t *testing.T) {
	withTerminal(t, true)
	args := buildExecArgs("podman", "ov-ubuntu", 1001, 1002, "", nil, "/workspace")
	want := []string{
		"podman", "exec", "-it",
		"--user", "1001:1002",
		"-w", "/workspace",
...
func TestBuildExecArgsWithEnvVars(t *testing.T) {
	...
	args := buildExecArgs("docker", "ov-myapp", 1000, 1000, "", envVars, "/workspace")
	want := []string{
		"docker", "exec", "-it",
		"--user", "1000:1000",
		"-w", "/workspace",
