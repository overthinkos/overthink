...
func TestVMCollector_Collect(t *testing.T) {
	cases := []struct {
		...
		},
		{
			...
			domains: []domainInfo{
				{Name: "ov-cachyos-gpu", State: "running"},
			},
			want: []DeploymentStatus{
				{
					Kind:      SubstrateVM,
		...
		},
		{
			...
			domains: []domainInfo{
				{Name: "ov-arch", State: "shut off"},
				{Name: "ov-k3s-vm", State: "paused"},
			},
			want: []DeploymentStatus{
				{Kind: SubstrateVM, Source: "libvirt", Image: "arch", Status: "stopped", Container: "ov-arch"},
				{Kind: SubstrateVM, Source: "libvirt", Image: "k3s-vm", Status: "paused", Container: "ov-k3s-vm"},
			},
		},
		{
