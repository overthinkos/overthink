...
// ContainerSnapshot is the cheap, batch-derived view of one ov-* container.
...
type ContainerSnapshot struct {
	Name        string        // "ov-selkies-desktop-185.52.136.164"
...
// SnapshotAll lists ov-* containers (one ps call), then runs one batched
...
// WlStatusCmd) that need probe data without enumerating every ov container.
