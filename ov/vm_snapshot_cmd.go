...
// vm_snapshot_cmd.go — Kong subcommand wiring for `ov vm snapshot {…}`.
// Wired into VmCmd via the Snapshot field (see vm.go).

// VmSnapshotCmd is the parent of `ov vm snapshot`.
...
// VmSnapshotCreateCmd implements `ov vm snapshot create <vm> <name>`.
...
// Run executes `ov vm snapshot create`.
...
// VmSnapshotListCmd implements `ov vm snapshot list <vm>`.
...
// VmSnapshotDeleteCmd implements `ov vm snapshot delete <vm> <name>`.
...
// VmSnapshotRevertCmd implements `ov vm snapshot revert <vm> <name>`.
...
// VmSnapshotPromoteCmd implements `ov vm snapshot promote <vm> <name>`.
